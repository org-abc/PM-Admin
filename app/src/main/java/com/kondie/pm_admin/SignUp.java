...
public class SignUp extends AppCompatActivity {
    ...
    private EditText fname, lname, email, phone, password, conf_pass, pin, minServiceFee;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pin = findViewById(R.id.i_fucks_with_it_pin3);
    ...
    View.OnClickListener signItUp = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (!fname.getText().toString().equalsIgnoreCase("") &&
                    ...
                    !pin.getText().toString().equalsIgnoreCase("") &&
    ...
    private String getImageName(){
        ...
        String imageName = "Skopo_driver_" + fname.getText().toString() + "_" + timeStamp;
